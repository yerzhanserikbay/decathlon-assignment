...
import com.decathlon.service.FileGenerate;
import com.decathlon.service.RankService;
import com.decathlon.service.generate.FileGenerateXml;
...
public class DecathlonApp {
    ...
    private DecathlonApp() {
        ...
        fileGenerate = new FileGenerateXml();
    }
